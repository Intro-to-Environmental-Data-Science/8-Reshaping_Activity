...
Pivot the data to a long format where you have a column of values that has the temperature values, and then another column that indicates whether that record is tempC_flow or tempC_pool.
